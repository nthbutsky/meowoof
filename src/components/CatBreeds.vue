<template>
  <div class="cat-breeds__container">
    <p class="label">Select your breed</p>
    <select name="breeds-drop-down" class="cat-breeds" v-model="selected_breed">
...
export default {
  ...
  methods: {
    ...
    getInfo() {
      ...
      this.description = selectedBreedArray.description;
